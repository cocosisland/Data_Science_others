##################### DROP TABLES - Drop any already existing table of specific name if any (it's like a reset)
...
##################### CREATE TABLES - Newly create tables with columns names and their specific constraints
